...
public class DuplicateLead {
	public static void main(String[] args) {
		...
		elementNewCompanyName.sendKeys("Infosys");
		
		WebElement elementNewFirstName=driver.findElement(By.id("createLeadForm_firstName"));
		elementNewFirstName.clear();
		elementNewFirstName.sendKeys("NewFirst");
		
		WebElement  elementCreateLeadNewButton=driver.findElement(By.className("smallSubmit"));
		elementCreateLeadNewButton.click();
